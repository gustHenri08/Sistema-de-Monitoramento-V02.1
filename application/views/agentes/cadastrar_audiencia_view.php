...
<head>
  ...
  <title>SMT | Cadastro de Saída Para Audiencia</title>
        ...
        <div class="box-body">
          <!--Inicio do Formulario-->
            ...
            <div class="form-group"> <!-- Nome do Detento-->
              ...
              <input type="text" class="form-control" required name="condutores" placeholder="Condutores" style="width:300px" value="<?= isset($saidadetentos) ? $saidadetentos["condutores"] : "" ?>" ><!-- 'name=' adicionado-->
            </div>
