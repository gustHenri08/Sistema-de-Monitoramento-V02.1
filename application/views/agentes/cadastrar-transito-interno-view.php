        ...
        <div class="box-header with-border">
         ...
         <div class="box-body">
          <!--Inicio do Formulario-->
              ...
              <form method="post" action="<?= base_url() ?>index.php/Saidatransito/createMasteri/<?= $saidadetentos["id"] ?>"> <!-- Chama a funtion de edição e para o id que será editado -->
              ...
              <div class="form-group"> <!-- Nome do Detento-->
          		...
          		<input type="text" class="form-control" required name="cadeiapublica" placeholder="Cadeia Publica" style="width:300px" readonly value="<?=$saidadetentos["cadeiapublica"]?>"><!-- 'name=' adicionado-->
          	</div>
            ...
            <div class="form-group"> <!--Campo Cadeia Publica-->
              ...
              <input type="text" class="form-control" required name="obs" placeholder="Obs Gerais" style="width:300px" ><!-- 'name=' adicionado-->
            </div>
