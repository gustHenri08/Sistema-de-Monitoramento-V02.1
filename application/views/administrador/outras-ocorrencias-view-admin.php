...
<div class="wrapper">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li>
                    <a href="<?php echo site_url('Home/adminHome'); ?>">
                        <!-- Link do Home, ao ser clicado ele retorna o controller-->
                        <i class="fa fa-home"></i> <span>Home</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo site_url('Home/agentes'); ?>">
                        <!-- Link do Home, ao ser clicado ele retorna o controller-->
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="<?php echo site_url('Home/saidaAudienciaAdmin'); ?>"><i class="fa fa-cab"></i>
                            Saída para Audiência</a></li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <h1>
                <p>Outras Ocorrências </p>
            </h1>
            <p></p>

            <ol class="breadcrumb">
                <!--Area referente ao Mapa de navegação do site (Precisa de melhorias)-->
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <select class="form-control" style="width: 200px" name="tipoOcorrencia">
                                     <!-- 'name=' adicionado-->
                                    <option>Motim</option>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="5"><textarea style="resize: none; height: 300px" class="form-control" rows="5" name="resumoOcorrencia" placeholder="Resumo da Ocorrência"></textarea>
                            </td>
                        </tr>
                        <tr>
