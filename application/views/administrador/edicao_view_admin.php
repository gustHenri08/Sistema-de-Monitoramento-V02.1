      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <?php if(isset($saidadetentos)) : ?>
              <form method="post" action="<?= base_url() ?>index.php/Cadastrar_sair/updateadmin/<?= $saidadetentos["id"] ?>"> <!-- Chama a funtion de edição e para o id que será editado -->
            ...
            <div class="form-group"> <!--Documentação-->
             ...
             <div class="form-group"> <!--Documentação-->
                ...
                <option><?=$saidadetentos["destino"]?></option>
                  <option>PCPE</option>
                  <option>PF</option>
                  <option>PM</option>
                  <option>PP</option>
            ...
            <div class="form-group"> <!--Observações-->
                  ...
                  <textarea class="form-control" rows="5" name="obs" placeholder="Observações"><?= isset($saidadetentos) ? $saidadetentos["obs"] : "" ?></textarea><!-- 'name=' adicionado-->
            </div>
